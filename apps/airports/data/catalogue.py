...
AIRPORTS: tuple[tuple[str, str, str, str, str, str, str, str], ...] = (
    ...
    # ---- Second pass ------------------------------------------------------
    # The gaps the first table left: the summer and city-break airports Gulf
    # travellers actually ask for (Batumi, Samarkand, Tbilisi's neighbours, the
    # Croatian and Greek coasts), the second airports of countries that had one,
    # and the long-haul cities the catalogue could not reach at all. Country
    # names come from the same CLDR data as the panel's country picker, so a
    # new row groups with the ones above rather than beside them.
    ("BUS", "Batumi International Airport", "مطار باتومي الدولي", "Batumi", "باتومي", "Georgia", "جورجيا", "GE"),
    ("EVN", "Zvartnots International Airport", "مطار زفارتنوتس الدولي", "Yerevan", "يريفان", "Armenia", "أرمينيا", "AM"),
    ("TZL", "Tuzla International Airport", "مطار توزلا الدولي", "Tuzla", "توزلا", "Bosnia and Herzegovina", "البوسنة والهرسك", "BA"),
    ("SKD", "Samarkand International Airport", "مطار سمرقند الدولي", "Samarkand", "سمرقند", "Uzbekistan", "أوزبكستان", "UZ"),
    ("BHK", "Bukhara International Airport", "مطار بخارى الدولي", "Bukhara", "بخارى", "Uzbekistan", "أوزبكستان", "UZ"),
    ("FRU", "Manas International Airport", "مطار ماناس الدولي", "Bishkek", "بيشكيك", "Kyrgyzstan", "قيرغيزستان", "KG"),
    ("NQZ", "Astana International Airport", "مطار أستانا الدولي", "Astana", "أستانا", "Kazakhstan", "كازاخستان", "KZ"),
    ("ISU", "Sulaymaniyah International Airport", "مطار السليمانية الدولي", "Sulaymaniyah", "السليمانية", "Iraq", "العراق", "IQ"),
    ("ZAG", "Franjo Tuđman Airport", "مطار فرانيو تودمان", "Zagreb", "زغرب", "Croatia", "كرواتيا", "HR"),
    ("SPU", "Split Airport", "مطار سبليت", "Split", "سبليت", "Croatia", "كرواتيا", "HR"),
    ("DBV", "Dubrovnik Airport", "مطار دوبروفنيك", "Dubrovnik", "دوبروفنيك", "Croatia", "كرواتيا", "HR"),
    ("SOF", "Sofia Airport", "مطار صوفيا", "Sofia", "صوفيا", "Bulgaria", "بلغاريا", "BG"),
    ("VAR", "Varna Airport", "مطار فارنا", "Varna", "فارنا", "Bulgaria", "بلغاريا", "BG"),
    ("OTP", "Henri Coandă International Airport", "مطار هنري كواندا الدولي", "Bucharest", "بوخارست", "Romania", "رومانيا", "RO"),
    ("BEG", "Belgrade Nikola Tesla Airport", "مطار بلغراد نيكولا تسلا", "Belgrade", "بلغراد", "Serbia", "صربيا", "RS"),
    ("TIA", "Tirana International Airport", "مطار تيرانا الدولي", "Tirana", "تيرانا", "Albania", "ألبانيا", "AL"),
    ("SKP", "Skopje International Airport", "مطار سكوبيه الدولي", "Skopje", "سكوبيه", "North Macedonia", "مقدونيا الشمالية", "MK"),
    ("TGD", "Podgorica Airport", "مطار بودغوريتسا", "Podgorica", "بودغوريتسا", "Montenegro", "الجبل الأسود", "ME"),
    ("KRK", "Kraków John Paul II International Airport", "مطار كراكوف الدولي", "Kraków", "كراكوف", "Poland", "بولندا", "PL"),
    ("RIX", "Riga International Airport", "مطار ريغا الدولي", "Riga", "ريغا", "Latvia", "لاتفيا", "LV"),
    ("VNO", "Vilnius Airport", "مطار فيلنيوس", "Vilnius", "فيلنيوس", "Lithuania", "ليتوانيا", "LT"),
    ("TLL", "Tallinn Airport", "مطار تالين", "Tallinn", "تالين", "Estonia", "إستونيا", "EE"),
    ("KEF", "Keflavík International Airport", "مطار كيفلافيك الدولي", "Reykjavík", "ريكيافيك", "Iceland", "آيسلندا", "IS"),
    ("LED", "Pulkovo Airport", "مطار بولكوفو", "Saint Petersburg", "سانت بطرسبرغ", "Russia", "روسيا", "RU"),
    ("PMI", "Palma de Mallorca Airport", "مطار بالما دي مايوركا", "Palma de Mallorca", "بالما دي مايوركا", "Spain", "إسبانيا", "ES"),
    ("IBZ", "Ibiza Airport", "مطار إيبيزا", "Ibiza", "إيبيزا", "Spain", "إسبانيا", "ES"),
    ("VLC", "Valencia Airport", "مطار فالنسيا", "Valencia", "فالنسيا", "Spain", "إسبانيا", "ES"),
    ("SVQ", "Seville Airport", "مطار إشبيلية", "Seville", "إشبيلية", "Spain", "إسبانيا", "ES"),
    ("TFS", "Tenerife South Airport", "مطار تينيريفي الجنوبي", "Tenerife", "تينيريفي", "Spain", "إسبانيا", "ES"),
    ("FAO", "Faro Airport", "مطار فارو", "Faro", "فارو", "Portugal", "البرتغال", "PT"),
    ("BLQ", "Bologna Guglielmo Marconi Airport", "مطار بولونيا", "Bologna", "بولونيا", "Italy", "إيطاليا", "IT"),
    ("FLR", "Florence Airport", "مطار فلورنسا", "Florence", "فلورنسا", "Italy", "إيطاليا", "IT"),
    ("CTA", "Catania Fontanarossa Airport", "مطار كاتانيا", "Catania", "كاتانيا", "Italy", "إيطاليا", "IT"),
    ("TRN", "Turin Airport", "مطار تورينو", "Turin", "تورينو", "Italy", "إيطاليا", "IT"),
    ("HER", "Heraklion International Airport", "مطار هيراكليون الدولي", "Heraklion", "هيراكليون", "Greece", "اليونان", "GR"),
    ("JTR", "Santorini Airport", "مطار سانتوريني", "Santorini", "سانتوريني", "Greece", "اليونان", "GR"),
    ("JMK", "Mykonos Airport", "مطار ميكونوس", "Mykonos", "ميكونوس", "Greece", "اليونان", "GR"),
    ("RHO", "Rhodes International Airport", "مطار رودس الدولي", "Rhodes", "رودس", "Greece", "اليونان", "GR"),
    ("SKG", "Thessaloniki Airport", "مطار ثيسالونيكي", "Thessaloniki", "ثيسالونيكي", "Greece", "اليونان", "GR"),
    ("LCA", "Larnaca International Airport", "مطار لارنكا الدولي", "Larnaca", "لارنكا", "Cyprus", "قبرص", "CY"),
    ("MLA", "Malta International Airport", "مطار مالطا الدولي", "Malta", "مالطا", "Malta", "مالطا", "MT"),
    ("MRS", "Marseille Provence Airport", "مطار مرسيليا بروفانس", "Marseille", "مرسيليا", "France", "فرنسا", "FR"),
    ("SZG", "Salzburg Airport", "مطار سالزبورغ", "Salzburg", "سالزبورغ", "Austria", "النمسا", "AT"),
    ("STN", "London Stansted Airport", "مطار لندن ستانستد", "London", "لندن", "United Kingdom", "المملكة المتحدة", "GB"),
    ("GLA", "Glasgow Airport", "مطار غلاسكو", "Glasgow", "غلاسكو", "United Kingdom", "المملكة المتحدة", "GB"),
    ("FEZ", "Fes–Saïss Airport", "مطار فاس سايس", "Fes", "فاس", "Morocco", "المغرب", "MA"),
    ("RBA", "Rabat–Salé Airport", "مطار الرباط سلا", "Rabat", "الرباط", "Morocco", "المغرب", "MA"),
    ("AGA", "Agadir–Al Massira Airport", "مطار أكادير المسيرة", "Agadir", "أكادير", "Morocco", "المغرب", "MA"),
    ("DJE", "Djerba–Zarzis Airport", "مطار جربة جرجيس", "Djerba", "جربة", "Tunisia", "تونس", "TN"),
    ("NBE", "Enfidha–Hammamet Airport", "مطار النفيضة الحمامات", "Enfidha", "النفيضة", "Tunisia", "تونس", "TN"),
    ("ORN", "Oran Es Sénia Airport", "مطار وهران السانيا", "Oran", "وهران", "Algeria", "الجزائر", "DZ"),
    ("SGN", "Tan Son Nhat International Airport", "مطار تان سون نات الدولي", "Ho Chi Minh City", "هو تشي منه", "Vietnam", "فيتنام", "VN"),
    ("HAN", "Noi Bai International Airport", "مطار نوي باي الدولي", "Hanoi", "هانوي", "Vietnam", "فيتنام", "VN"),
    ("DAD", "Da Nang International Airport", "مطار دا نانغ الدولي", "Da Nang", "دا نانغ", "Vietnam", "فيتنام", "VN"),
    ("PNH", "Phnom Penh International Airport", "مطار بنوم بنه الدولي", "Phnom Penh", "بنوم بنه", "Cambodia", "كمبوديا", "KH"),
    ("REP", "Siem Reap Angkor International Airport", "مطار سييم ريب أنكور الدولي", "Siem Reap", "سييم ريب", "Cambodia", "كمبوديا", "KH"),
    ("USM", "Samui Airport", "مطار كوه ساموي", "Koh Samui", "كوه ساموي", "Thailand", "تايلاند", "TH"),
    ("KBV", "Krabi International Airport", "مطار كرابي الدولي", "Krabi", "كرابي", "Thailand", "تايلاند", "TH"),
    ("LGK", "Langkawi International Airport", "مطار لنكاوي الدولي", "Langkawi", "لنكاوي", "Malaysia", "ماليزيا", "MY"),
    ("PEN", "Penang International Airport", "مطار بينانغ الدولي", "Penang", "بينانغ", "Malaysia", "ماليزيا", "MY"),
    ("BKI", "Kota Kinabalu International Airport", "مطار كوتا كينابالو الدولي", "Kota Kinabalu", "كوتا كينابالو", "Malaysia", "ماليزيا", "MY"),
    ("CEB", "Mactan–Cebu International Airport", "مطار سيبو الدولي", "Cebu", "سيبو", "Philippines", "الفلبين", "PH"),
    ("GOI", "Goa International Airport", "مطار غوا الدولي", "Goa", "غوا", "India", "الهند", "IN"),
    ("JAI", "Jaipur International Airport", "مطار جايبور الدولي", "Jaipur", "جايبور", "India", "الهند", "IN"),
    ("CCU", "Netaji Subhas Chandra Bose International Airport", "مطار كولكاتا الدولي", "Kolkata", "كولكاتا", "India", "الهند", "IN"),
    ("AMD", "Ahmedabad International Airport", "مطار أحمد آباد الدولي", "Ahmedabad", "أحمد آباد", "India", "الهند", "IN"),
    ("MFM", "Macau International Airport", "مطار ماكاو الدولي", "Macau", "ماكاو", "Macao", "ماكاو", "MO"),
    ("PUS", "Gimhae International Airport", "مطار غيمهاي الدولي", "Busan", "بوسان", "South Korea", "كوريا الجنوبية", "KR"),
    ("CTS", "New Chitose Airport", "مطار تشيتوسي الجديد", "Sapporo", "سابورو", "Japan", "اليابان", "JP"),
    ("FUK", "Fukuoka Airport", "مطار فوكوكا", "Fukuoka", "فوكوكا", "Japan", "اليابان", "JP"),
    ("SZX", "Shenzhen Bao'an International Airport", "مطار شنتشن باوان الدولي", "Shenzhen", "شنتشن", "China", "الصين", "CN"),
    ("CTU", "Chengdu Tianfu International Airport", "مطار تشنغدو تيانفو الدولي", "Chengdu", "تشنغدو", "China", "الصين", "CN"),
    ("XIY", "Xi'an Xianyang International Airport", "مطار شيان شيانيانغ الدولي", "Xi'an", "شيان", "China", "الصين", "CN"),
    ("DFW", "Dallas/Fort Worth International Airport", "مطار دالاس فورت وورث الدولي", "Dallas", "دالاس", "United States", "الولايات المتحدة", "US"),
    ("ATL", "Hartsfield–Jackson Atlanta International Airport", "مطار أتلانتا الدولي", "Atlanta", "أتلانتا", "United States", "الولايات المتحدة", "US"),
    ("SEA", "Seattle–Tacoma International Airport", "مطار سياتل تاكوما الدولي", "Seattle", "سياتل", "United States", "الولايات المتحدة", "US"),
    ("LAS", "Harry Reid International Airport", "مطار لاس فيغاس الدولي", "Las Vegas", "لاس فيغاس", "United States", "الولايات المتحدة", "US"),
    ("MCO", "Orlando International Airport", "مطار أورلاندو الدولي", "Orlando", "أورلاندو", "United States", "الولايات المتحدة", "US"),
    ("CUN", "Cancún International Airport", "مطار كانكون الدولي", "Cancún", "كانكون", "Mexico", "المكسيك", "MX"),
    ("PTY", "Tocumen International Airport", "مطار توكومين الدولي", "Panama City", "مدينة بنما", "Panama", "بنما", "PA"),
    ("LIM", "Jorge Chávez International Airport", "مطار خورخي تشافيز الدولي", "Lima", "ليما", "Peru", "بيرو", "PE"),
    ("BOG", "El Dorado International Airport", "مطار إلدورادو الدولي", "Bogotá", "بوغوتا", "Colombia", "كولومبيا", "CO"),
    ("SCL", "Arturo Merino Benítez International Airport", "مطار سانتياغو الدولي", "Santiago", "سانتياغو", "Chile", "تشيلي", "CL"),
)
# fmt: on
