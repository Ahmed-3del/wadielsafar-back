...
# The search's "you might also like" rail used to be hard-coded directly under
# the results, with no row in this table and nothing an editor could do about
# it. It becomes a section like any other here — inserted at the very front,
# which is where it already renders, so nothing on the live site moves.
KEY = "RECOMMENDATIONS"
...
class Migration(migrations.Migration):
    dependencies = [("pages", "0006_drop_branches_home_section")]
